...
class _TensorboardAdapter:
    ...
    def __init__(self, config):
        ...
        import os
        if config['trainer']['logger_dir']:
            tensorboard_dir = config['trainer']['logger_dir']
        else:
            tensorboard_dir = os.environ.get("TENSORBOARD_DIR", "tensorboard_log")
        tensorboard_dir = os.path.join(tensorboard_dir, datetime.datetime.now().strftime('%Y%m%d%H%M%S'))
