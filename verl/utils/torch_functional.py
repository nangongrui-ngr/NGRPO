...
def get_linear_schedule_with_warmup_and_decay(
    ...
    - linearly increases from 0 to 1 during a warmup period
    - linearly decreases from 1 to 0 after the warmup period until training is complete
    ...
    Returns:
        PyTorch LambdaLR scheduler with the appropriate schedule
    """
    def lr_lambda(current_step):
        if current_step < num_warmup_steps:
            # Linear warmup phase
            ...
            # Linear decay phase from 1 to 0
            return max(
                0.0,
