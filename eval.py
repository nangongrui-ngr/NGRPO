...
def prepare_data(example, prompt_key, think_mode="normal"):
    if think_mode == "normal":
...
def main():
    ...
    parser.add_argument("--think_mode", type=str, default="normal")
    ...
    for dataset_name in datasets:
        ...
        if "math" in dataset_name.lower():
            ...
            prompt_key = "problem"
            answer_key = "answer"
        dataset = dataset.map(lambda x: prepare_data(x, prompt_key, args.think_mode), num_proc=args.dataset_num_proc)
